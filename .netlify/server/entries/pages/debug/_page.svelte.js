...
function _page($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="debug-container svelte-1qg9r69"><h1>Environment Debug</h1> <div class="section svelte-1qg9r69"><h2>Environment Variables Status</h2> <div class="env-vars svelte-1qg9r69"><!--[-->`);
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let [key, isSet] = each_array[$$index];
    $$payload.out.push(`<div class="env-var svelte-1qg9r69"><strong>${escape_html(key)}:</strong> <span${attr_class("svelte-1qg9r69", void 0, { "error": !isSet })}>${escape_html(isSet ? "✅ Set" : "❌ Missing")}</span></div>`);
  }
