import { E as store_get, J as escape_html, M as ensure_array_like, G as attr_class, P as stringify, K as attr, I as unsubscribe_stores, B as pop, z as push, Q as clsx, R as bind_props, N as maybe_selected, S as copy_payload, T as assign_payload, F as head } from "../../../../chunks/index2.js";
...
function VehicleList($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="vehicle-list svelte-xpvu76"><div class="header svelte-xpvu76"><div class="header-content svelte-xpvu76"><h2 class="svelte-xpvu76">Vehicles</h2> <p class="subtitle svelte-xpvu76">Manage your fleet vehicles, registration, and maintenance information</p></div> <div class="header-actions svelte-xpvu76">`);
  if (oncreate) {
    $$payload.out.push("<!--[-->");
    Button($$payload, {
      variant: "primary",
      onclick: oncreate,
      children: ($$payload2) => {
        $$payload2.out.push(`<span class="icon svelte-xpvu76">➕</span> Add Vehicle`);
      }
    });
  } else {
    $$payload.out.push("<!--[!-->");
  ...
  if (store_get($$store_subs ??= {}, "$vehicleLoading", vehicleLoading) === "loading") {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div class="loading-state svelte-xpvu76"><div class="spinner svelte-xpvu76"></div> <p>Loading vehicles...</p></div>`);
  } else {
    $$payload.out.push("<!--[!-->");
    if (store_get($$store_subs ??= {}, "$vehicleError", vehicleError)) {
      ...
      Card($$payload, {
        class: "error-card",
        children: ($$payload2) => {
          $$payload2.out.push(`<div class="error-content svelte-xpvu76"><span class="error-icon svelte-xpvu76">⚠️</span> <div><h3 class="svelte-xpvu76">Failed to Load Vehicles</h3> <p class="svelte-xpvu76">${escape_html(store_get($$store_subs ??= {}, "$vehicleError", vehicleError))}</p> `);
          {
      ...
      if (store_get($$store_subs ??= {}, "$vehicles", vehicles).length === 0) {
        ...
        Card($$payload, {
          class: "empty-state",
          children: ($$payload2) => {
            $$payload2.out.push(`<div class="empty-content svelte-xpvu76"><span class="empty-icon svelte-xpvu76">🚜</span> <h3 class="svelte-xpvu76">No Vehicles Found</h3> <p class="svelte-xpvu76">Get started by adding your first vehicle to the fleet.</p> `);
            if (oncreate) {
              $$payload2.out.push("<!--[-->");
              Button($$payload2, {
                variant: "primary",
        ...
        $$payload.out.push(`<div class="stats svelte-xpvu76">`);
        Card($$payload, {
          padding: "small",
          children: ($$payload2) => {
            $$payload2.out.push(`<div class="stat svelte-xpvu76"><span class="stat-value svelte-xpvu76">${escape_html(store_get($$store_subs ??= {}, "$vehicles", vehicles).length)}</span> <span class="stat-label svelte-xpvu76">Total Vehicles</span></div>`);
          }
        });
        $$payload.out.push(`<!----> `);
        Card($$payload, {
          padding: "small",
          children: ($$payload2) => {
            $$payload2.out.push(`<div class="stat svelte-xpvu76"><span class="stat-value svelte-xpvu76">${escape_html(store_get($$store_subs ??= {}, "$vehicles", vehicles).filter((v) => v.active).length)}</span> <span class="stat-label svelte-xpvu76">Active</span></div>`);
          }
        });
        $$payload.out.push(`<!----> `);
        Card($$payload, {
          padding: "small",
          children: ($$payload2) => {
            $$payload2.out.push(`<div class="stat svelte-xpvu76"><span class="stat-value svelte-xpvu76">${escape_html(store_get($$store_subs ??= {}, "$vehicles", vehicles).filter((v) => !v.active).length)}</span> <span class="stat-label svelte-xpvu76">Inactive</span></div>`);
          }
        });
        $$payload.out.push(`<!----></div> <div class="vehicle-table-container svelte-xpvu76"><table class="vehicle-table svelte-xpvu76"><thead><tr><th class="svelte-xpvu76">Type</th><th class="svelte-xpvu76">Code</th><th class="svelte-xpvu76">Name</th><th class="svelte-xpvu76">Registration</th><th class="svelte-xpvu76">Make/Model</th><th class="svelte-xpvu76">Year</th><th class="svelte-xpvu76">Fuel Type</th><th class="svelte-xpvu76">Odometer</th><th class="svelte-xpvu76">Status</th><th class="svelte-xpvu76">Actions</th></tr></thead><tbody><!--[-->`);
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          let vehicle = each_array[$$index];
          $$payload.out.push(`<tr class="vehicle-row svelte-xpvu76"><td class="type-cell svelte-xpvu76"><span class="type-text svelte-xpvu76">${escape_html(vehicle.type)}</span></td><td class="code-cell svelte-xpvu76">${escape_html(vehicle.code)}</td><td class="name-cell svelte-xpvu76">${escape_html(vehicle.name)}</td><td class="registration-cell svelte-xpvu76">${escape_html(vehicle.registration)}</td><td class="make-model-cell svelte-xpvu76">${escape_html(vehicle.make && vehicle.model ? `${vehicle.make} ${vehicle.model}` : "-")}</td><td class="year-cell svelte-xpvu76">${escape_html(vehicle.year || "-")}</td><td class="fuel-type-cell svelte-xpvu76"><span${attr_class(`fuel-badge ${stringify(vehicle.fuel_type || "diesel")}`, "svelte-xpvu76")}>${escape_html(vehicle.fuel_type || "diesel")}</span></td><td class="odometer-cell svelte-xpvu76">${escape_html(formatOdometer(vehicle))}</td><td class="status-cell svelte-xpvu76"><span${attr_class(`status ${stringify(vehicle.active ? "active" : "inactive")}`, "svelte-xpvu76")}>${escape_html(vehicle.active ? "Active" : "Inactive")}</span></td><td class="actions-cell svelte-xpvu76"><div class="action-buttons svelte-xpvu76">`);
          Button($$payload, {
            size: "sm",
            variant: "outline",
            onclick: (e) => {
          ...
          $$payload.out.push(`<!----> <a${attr("href", `/fleet/vehicles/${stringify(vehicle.id)}`)} class="svelte-xpvu76">`);
          Button($$payload, {
            size: "sm",
            variant: "primary",
            children: ($$payload2) => {
...
function Input($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="input-group svelte-138axrz">`);
  if (label) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<label${attr("for", inputId)} class="input-label svelte-138axrz">${escape_html(label)} `);
    if (required) {
      $$payload.out.push("<!--[-->");
      $$payload.out.push(`<span class="required svelte-138axrz">*</span>`);
    } else {
      $$payload.out.push("<!--[!-->");
    }
  ...
  $$payload.out.push(`<!--]--> <input${attr("type", type)}${attr("id", inputId)}${attr("name", name)}${attr("value", value)}${attr("placeholder", placeholder)}${attr("required", required, true)}${attr("disabled", disabled, true)}${attr("readonly", readonly, true)}${attr("min", min)}${attr("max", max)}${attr("step", step)}${attr("autocomplete", autocomplete)}${attr_class(clsx(classes), "svelte-138axrz")}${attr("aria-invalid", !!error)}${attr("aria-describedby", error ? `${inputId}-error` : void 0)}/> `);
  if (error) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div${attr("id", `${stringify(inputId)}-error`)} class="input-error-message svelte-138axrz">${escape_html(error)}</div>`);
  } else {
    $$payload.out.push("<!--[!-->");
  }
  $$payload.out.push(`<!--]--></div>`);
...
function Select($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="select-group svelte-gjx2ev">`);
  if (label) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<label${attr("for", selectId)} class="select-label svelte-gjx2ev">${escape_html(label)} `);
    if (required) {
      $$payload.out.push("<!--[-->");
      $$payload.out.push(`<span class="required svelte-gjx2ev">*</span>`);
    } else {
      $$payload.out.push("<!--[!-->");
    }
    $$payload.out.push(`<!--]--></label>`);
  ...
  $$payload.out.push(`<!--]--> <select${attr("id", selectId)}${attr("name", name)}${attr("required", required, true)}${attr("disabled", disabled, true)}${attr_class(clsx(classes), "svelte-gjx2ev")}${attr("aria-invalid", !!error)}${attr("aria-describedby", error ? `${selectId}-error` : void 0)}>`);
  ...
  if (error) {
    $$payload.out.push("<!--[-->");
    $$payload.out.push(`<div${attr("id", `${stringify(selectId)}-error`)} class="select-error-message svelte-gjx2ev">${escape_html(error)}</div>`);
  } else {
    $$payload.out.push("<!--[!-->");
  }
  $$payload.out.push(`<!--]--></div>`);
...
function VehicleForm($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    Card($$payload2, {
      ...
      children: ($$payload3) => {
        $$payload3.out.push(`<div class="form-header svelte-1j801zg"><h2 class="svelte-1j801zg">${escape_html(formTitle)}</h2> <p class="form-subtitle svelte-1j801zg">${escape_html(isEditing ? "Update vehicle information" : "Add a new vehicle to your fleet")}</p></div> <form class="vehicle-form svelte-1j801zg">`);
        if (errors.submit) {
          $$payload3.out.push("<!--[-->");
          $$payload3.out.push(`<div class="form-error svelte-1j801zg"><span class="error-icon svelte-1j801zg">⚠️</span> ${escape_html(errors.submit)}</div>`);
        } else {
          $$payload3.out.push("<!--[!-->");
        }
        $$payload3.out.push(`<!--]--> <div class="form-row svelte-1j801zg"><div class="form-group svelte-1j801zg">`);
        Input($$payload3, {
          label: "Vehicle Code",
        ...
        $$payload3.out.push(`<!----> <div class="form-row svelte-1j801zg">`);
        Input($$payload3, {
          type: "number",
        ...
        $$payload3.out.push(`<!----> <div class="form-section svelte-1j801zg"><h3 class="svelte-1j801zg">Optional Information</h3> <div class="form-row svelte-1j801zg">`);
        Input($$payload3, {
          label: "Make",
        ...
        $$payload3.out.push(`<!----></div> <div class="form-actions svelte-1j801zg">`);
        {
          let children = function($$payload4) {
...
function VehicleDetail($$payload, $$props) {
  ...
  Card($$payload, {
    ...
    children: ($$payload2) => {
      $$payload2.out.push(`<div class="detail-header svelte-12sjwap"><div class="vehicle-title svelte-12sjwap"><div class="vehicle-icon svelte-12sjwap">${escape_html(getVehicleTypeIcon(vehicle.type))}</div> <div class="title-info svelte-12sjwap"><h2 class="svelte-12sjwap">${escape_html(vehicle.name)}</h2> <div class="vehicle-code svelte-12sjwap">Code: ${escape_html(vehicle.code)}</div></div></div> <div class="status-badge svelte-12sjwap"><span${attr_class(`status ${stringify(vehicle.active ? "active" : "inactive")}`, "svelte-12sjwap")}>${escape_html(vehicle.active ? "Active" : "Inactive")}</span></div></div> <div class="detail-content svelte-12sjwap"><div class="detail-section svelte-12sjwap"><h3 class="svelte-12sjwap">Basic Information</h3> <div class="detail-grid svelte-12sjwap"><div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Vehicle Type:</span> <span class="value type-value svelte-12sjwap">${escape_html(vehicle.type)}</span></div> <div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Registration:</span> <span class="value registration svelte-12sjwap">${escape_html(vehicle.registration)}</span></div> <div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Fuel Type:</span> <span class="value fuel-type svelte-12sjwap">${escape_html(vehicle.fuel_type || "diesel")}</span></div> <div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Current Odometer:</span> <span class="value odometer svelte-12sjwap">${escape_html(formatOdometer(vehicle))}</span></div></div></div> `);
      if (vehicle.make || vehicle.model || vehicle.year) {
        $$payload2.out.push("<!--[-->");
        $$payload2.out.push(`<div class="detail-section svelte-12sjwap"><h3 class="svelte-12sjwap">Vehicle Specifications</h3> <div class="detail-grid svelte-12sjwap">`);
        if (vehicle.make) {
          $$payload2.out.push("<!--[-->");
          $$payload2.out.push(`<div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Make:</span> <span class="value svelte-12sjwap">${escape_html(vehicle.make)}</span></div>`);
        } else {
          $$payload2.out.push("<!--[!-->");
        }
        $$payload2.out.push(`<!--]--> `);
        if (vehicle.model) {
          $$payload2.out.push("<!--[-->");
          $$payload2.out.push(`<div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Model:</span> <span class="value svelte-12sjwap">${escape_html(vehicle.model)}</span></div>`);
        } else {
          $$payload2.out.push("<!--[!-->");
        }
        $$payload2.out.push(`<!--]--> `);
        if (vehicle.year) {
          $$payload2.out.push("<!--[-->");
          $$payload2.out.push(`<div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Year:</span> <span class="value svelte-12sjwap">${escape_html(vehicle.year)}</span></div>`);
        } else {
          $$payload2.out.push("<!--[!-->");
        }
        $$payload2.out.push(`<!--]--></div></div>`);
      ...
      $$payload2.out.push(`<!--]--> <div class="detail-section svelte-12sjwap"><h3 class="svelte-12sjwap">System Information</h3> <div class="detail-grid svelte-12sjwap"><div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Created:</span> <span class="value svelte-12sjwap">${escape_html(formatDate(vehicle.created_at))}</span></div> <div class="detail-item svelte-12sjwap"><span class="label svelte-12sjwap">Last Updated:</span> <span class="value svelte-12sjwap">${escape_html(formatDate(vehicle.updated_at))}</span></div></div></div> <div class="detail-section svelte-12sjwap"><h3 class="svelte-12sjwap">Usage Statistics</h3> <div class="stats-placeholder svelte-12sjwap"><p class="svelte-12sjwap">📊 Fuel usage statistics and maintenance records will be available here once data is collected.</p></div></div></div> <div class="detail-actions svelte-12sjwap">`);
      {
        let children = function($$payload3) {
      ...
      $$payload2.out.push(`<!----> <div class="action-group svelte-12sjwap">`);
      {
        let children = function($$payload3) {
          $$payload3.out.push(`<span class="action-icon svelte-12sjwap">✏️</span> Edit`);
        };
        Button($$payload2, {
          variant: "primary",
          onclick: handleEdit,
      ...
      {
        let children = function($$payload3) {
          $$payload3.out.push(`<span class="action-icon svelte-12sjwap">🗑️</span> Delete`);
        };
        Button($$payload2, {
          variant: "error",
...
function _page($$payload, $$props) {
  ...
  $$payload.out.push(`<div class="fleet-management svelte-1wt56jm"><div class="container svelte-1wt56jm"><div class="page-header svelte-1wt56jm"><h1 class="svelte-1wt56jm">Database Management</h1> <p class="subtitle svelte-1wt56jm">Manage vehicles, drivers, bowsers, activities, fields, and zones</p></div> <div class="section-tabs svelte-1wt56jm"><!--[-->`);
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let section = each_array[$$index];
    $$payload.out.push(`<button${attr_class("tab-btn svelte-1wt56jm", void 0, { "active": section.id === selectedSection })}><span class="tab-label svelte-1wt56jm">${escape_html(section.label)}</span></button>`);
  }
  $$payload.out.push(`<!--]--></div> <div class="section-content svelte-1wt56jm">`);
  {
    $$payload.out.push("<!--[-->");
    if (vehicleView === "list") {
      $$payload.out.push("<!--[-->");
